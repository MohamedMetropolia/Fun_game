...
values ("Maze","You find yourself waking up in a maze. You have to find the exit in order to survive.","maze_map.png",1,"Where do you want to go? ","","","","","","",0,0,"","","",3,0,4,2,0,0),
       ...
       ("Crossroad","As you were moving you realize you''ve come to an intersection in the maze","crossroad_map.png",1,"Where do you want to go? ","","","","","","",0,0,"","","",9,1,8,5,0,0),
       ("Graveyard","In the distance you see some slim silhouettes in the fog. As you walk closer, you realize that those are tombstones and you find yourself in the middle of a graveyard.","graveyard_map.png",1,"Where do you want to go? ","","","","","","",0,0,"","","",0,0,17,1,0,0),
       ("Forest","You find yourself entering a forest","forest_map.png",1,"Where do you want to go? ","","","","","","",0,0,"","","",10,6,3,7,0,0),
       ("Necropolis","The sight of an ancient burial cite greets you. However, your foot misses the path, and suddenly the graves don't look as peaceful anymore.","necropolis_map.png",1,"A horde of undead dogs lunge at you, flesh falling off their bones.","undeadDogs.png","Would you like to use your item?","","You sent the dogs back to their graves. It looks like you're in the clear.","","You get moulled by the dogs and you join them in their graves...END...",0,0,"","","",5,12,0,0,4,0),
       ("Fork","This path leads you outside to a fork","fork_map.png",1,"Where do you want to go? ","","","","","","",0,0,"","","",24,25,5,15,0,0),
       ...
       ("Shrine","A holy glow radiates from between the trees. A stone shrine is sitting in a clearing in the woods, surrounded by offerings.","shrine_map.png",1,"The guardian spirit emerge from the shrine, he wants to ask you a riddle before you pass","guargian.png","","","The guardian seems to be pleased with your answer and grant you some gold","","The guardian looks dissappointed, this wasn't the answer they looked for.",0,0,"","","",15,0,13,0,0,1),
       ...
       ("Hut","A worn-down hut stands near the entrance to the forest. An old man is sitting on the porch, carving a wooden figure. From the looks of it, he is making a wooden wolf.","hut_map.png",1,"The old man looks at you and says: I have some gift for you, kid. But you only get it if you answer my riddle correctly.","oldMan.png","","","You answer the old man riddle correctly, he hands you some gold","","That was not the correct answer for the old man riddle, you leave empty handed",0,0,"","","",12,0,2,0,0,1),
