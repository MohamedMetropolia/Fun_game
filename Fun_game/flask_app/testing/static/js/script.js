...
function renderLocation(location) {
  ...
  document.querySelector(
      '#current_item').innerHTML = `Current item: ${location.item.description}`; //todo: define current item variable
  document.querySelector(
      '#current_location').innerHTML = `Current location: ${location.location_name}`;
  //add location text to the html
  document.querySelector('.gametext').innerHTML = location.location_text; //todo: needs to be defined
